...
const ScoreCard = ({ title, value, icon, colorClass = "text-primary bg-primary-50" }) => {
  return (
    <div className="glass-panel p-6 rounded-2xl flex items-center gap-5 group hover:-translate-y-1 transition-all duration-300 hover:shadow-soft-lg cursor-default">
